  ...
  return (
    <>
      <SeoHead
        ...
        canonical={siteUrl(`/kommersiella-dronare/${industry.slug}`)}
        breadcrumbs={[
          { name: "Hem", url: siteUrl("/") },
          { name: "Kommersiella drönare", url: siteUrl("/kommersiella-dronare") },
          { name: industry.title, url: siteUrl(`/kommersiella-dronare/${industry.slug}`) },
        ]}
      ...
      <div className="min-h-screen bg-[#0a0a0a] text-white">
        ...
        />
        <RelatedPages pageUrl={siteUrl(`/kommersiella-dronare/${industry.slug}`)} heading="Relaterade sidor" />
