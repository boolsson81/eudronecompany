...
export const DRONE_CATEGORIES: DroneCategory[] = [
  {
    ...
    icon: Plane,
    description: "Kategori A1 tillåter flygning över människor (men inte folksamlingar) med drönare under 250g eller C0/C1-klassade drönare. För C1 krävs A1/A3-onlinekurs och prov via Transportstyrelsen. För C0 under 250 g är kompetenskravet inte obligatoriskt, men kursen rekommenderas.",
    maxWeight: "< 250g (C0) eller < 900g (C1)",
    requiresRegistration: true,
    requiresInsurance: true,
    pilotAge: "Minst 16 år (undantag för leksaksdrönare)",
    trainingRequired: "A1/A3 onlinekurs + prov hos Transportstyrelsen (krävs för C1, frivilligt för C0)",
    examRequired: true,
  ...
  },
  {
    ...
    icon: Shield,
    description: "Kategori A2 tillåter flygning nära människor (minst 30m, eller 5m i låghastighetsläge) med C2-klassade drönare upp till 4 kg. Kräver A1/A3-utbildning plus separat A2-certifikat: praktiska självstudier som du intygar själv, följt av ett teoriprov. Något praktiskt prov finns inte.",
    maxWeight: "< 4 kg (C2)",
    requiresRegistration: true,
    requiresInsurance: true,
    pilotAge: "Minst 16 år",
    trainingRequired: "A1/A3-utbildning + A2-certifikat (teoriprov, praktiken intygas av piloten)",
    examRequired: true,
    operationalLimitations: [
      "Max flyghöjd 120 meter över marken",
    ...
    allowedDrones: [
      { name: "DJI Mavic 3 Enterprise", weight: "915g", category: "C2", classLabel: "Open A2", notes: "Bär EU-C2-märkning. Kräver A2-certifikat för flygning nära oberoende personer." },
      { name: "DJI Mavic 3 Pro", weight: "958g", category: "C2", classLabel: "Open A2", notes: "Över 900 g och kan därför inte C1-märkas — A1 är inte möjligt. A2-certifikat krävs för flygning nära oberoende personer." },
    ],
  ...
  },
  {
    ...
    allowedDrones: [
      { name: "DJI Matrice 350 RTK", weight: "6,47 kg", category: "Utan C-märkning", classLabel: "Open A3", notes: "Saknar C-klassmärkning och hör därför hemma i A3, upp till 25 kg. Specific krävs först vid BVLOS, flygning nära människor eller annat utanför Open." },
