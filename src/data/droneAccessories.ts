...
export const DRONE_ACCESSORIES: Record<string, DroneAccessory[]> = {
  "DJI Matrice 400": [
    { name: "Zenmuse H30T", category: "payload", desc: "Bred vidvinkel, 34× optisk zoom, LRF, termisk kamera. DJI:s mest avancerade payload med termisk sensor.", badge: "Ny", shopUrl: "https://www.actionking.se/products/dji-zenmuse-h30t-dronarkamera", imageUrl: zenmuseH30TImg },
    { name: "Zenmuse H30", category: "payload", desc: "Bred vidvinkel, 34× optisk zoom, LRF. DJI:s mest avancerade payload utan termisk sensor.", badge: "Ny", shopUrl: "https://www.actionking.se/products/dji-zenmuse-h30-dronarkamera", imageUrl: zenmuseH30Img },
    { name: "Zenmuse S1", category: "payload", desc: "Sökljus-payload med 10 000 lumen och belysning upp till 500 m. Perfekt för nattliga insatser och räddningsoperationer.", badge: "Ny", shopUrl: "https://www.actionking.se/products/dji-zenmuse-s1-dronarkamera", imageUrl: zenmuseS1Img },
    { name: "Zenmuse V1", category: "payload", desc: "Röstförstärkare med 129 dB och 700 m effektiv räckvidd. Idealisk för räddning, säkerhet och crowd management.", badge: "Ny", shopUrl: "https://www.actionking.se/products/dji-zenmuse-v1-kamerastabilisator", imageUrl: zenmuseV1Img },
  ],
  ...
  "DJI Matrice 350 RTK": [
    ...
    { name: "Zenmuse H20T (Termisk)", category: "payload", desc: "Termisk 640×512, radiometrisk mätning, 20 MP zoomkamera + 12 MP vidvinkel.", shopUrl: "https://actionking.se/search?q=zenmuse+h20t" },
