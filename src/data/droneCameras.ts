...
export const DRONE_CAMERAS: DroneCamera[] = [
  {
    ...
    name: "Zenmuse H30T",
    shortDesc: "DJI:s mest avancerade hybridpayload med termisk sensor, 34× zoom och laser-avståndsmätare.",
    category: "thermal",
    badge: "Ny",
    ...
    specs: [
      ...
      { label: "Zoomsensor", value: "1/1,8\" CMOS, 40 MP" },
      { label: "Optisk zoom", value: "34× optisk (upp till 400× digital)" },
  ...
  },
  {
    ...
    name: "Zenmuse H30",
    shortDesc: "Avancerad hybridpayload med 34× optisk zoom och laser-avståndsmätare — utan termisk sensor.",
    category: "inspection",
    badge: "Ny",
  ...
  },
  {
    ...
    name: "Zenmuse H20N",
    shortDesc: "Nattseende-hybrid med starlight-sensorer, dubbla termiska kameror och 20× zoom — optimerad för mörker.",
    category: "thermal",
    ...
    specs: [
      ...
      { label: "Vidvinkelssensor", value: "Starlight CMOS, 2 MP" },
      { label: "Zoomsensor", value: "Starlight CMOS, 4 MP" },
      { label: "Optisk zoom", value: "20× optisk (upp till 128× hybrid)" },
      { label: "Termisk sensor", value: "Dubbla 640×512 (2× och 8×), radiometriska" },
      { label: "Laser-avståndsmätare", value: "3–1200 m" },
      { label: "LiDAR", value: "—" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Termisk sensor", value: "—" },
      { label: "Laser-avståndsmätare", value: "—" },
      { label: "LiDAR", value: "Upp till 5 returer, 250 m @ 10 % reflektans, 240 000 pts/s" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Termisk sensor", value: "—" },
      { label: "Laser-avståndsmätare", value: "—" },
      { label: "LiDAR", value: "Upp till 3 returer, 450 m @ 80 % reflektans, 240 000 pts/s" },
      { label: "Max upplösning", value: "20 MP (RGB-foto)" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Termisk sensor", value: "—" },
      { label: "Laser-avståndsmätare", value: "—" },
      { label: "LiDAR", value: "Upp till 16 returer, 950 m @ 10 % reflektans, 100 kHz–2 MHz" },
