...
export const INDUSTRY_DATA: IndustryData[] = [
  {
    ...
    solutions: [
      { slug: "takinspektion", title: "Takinspektion", desc: "Dokumentera skador och slitage utan byggnadsställning. Spara tid och minska risker.", longDesc: "Drönare revolutionerar takinspektioner genom att eliminera behovet av byggnadsställning och manuell klättring. Med högupplösta kameror och termisk avbildning kan du snabbt identifiera skador, läckor och slitage — säkrare, snabbare och billigare.", seoTitle: "Takinspektion med Drönare — Snabbare & Säkrare | ActionKing", seoDesc: "Inspektera tak med drönare utan byggnadsställning. Termisk och visuell dokumentation av skador och slitage. Kontakta ActionKing för offert.", useCases: ["Bostadsrättsföreningar och fastighetsbolag", "Försäkringsärenden och skadedokumentation", "Förebyggande underhåll av kommersiella fastigheter", "Storskalig inspektion av lager- och industritak"], keyFeatures: ["Termisk kamera för att hitta dolda läckor", "Högupplösta bilder med zoom upp till 200×", "Automatisk rapportgenerering med AI", "Ingen byggnadsställning behövs"] },
      { slug: "fasadinspektion", title: "Fasadinspektion", desc: "Detaljerade bilder av fasader och konstruktioner med zoom- och termisk kamera.", longDesc: "Med drönare kan fasader inspekteras i detalj utan att personal behöver arbeta på höjd. Zoom- och termiska kameror avslöjar sprickor, fuktskador och isoleringsbrister som inte syns med blotta ögat.", seoTitle: "Fasadinspektion med Drönare — Detaljerad Dokumentation | ActionKing", seoDesc: "Inspektera fasader med drönare. Hitta sprickor, fuktskador och isoleringsbrister med termisk och visuell kamera. Begär offert.", useCases: ["Fasadrenoveringar och tillståndsbesiktningar", "Fuktanalys av bostadshus och kontor", "Kulturarvsinventering och dokumentation", "Kvalitetskontroll vid nybyggnation"], keyFeatures: ["56× optisk zoom för detaljgranskning", "Termisk kamera för fukt- och isoleringsanalys", "3D-modellering av hela fasaden", "Säker inspektion utan lift eller ställning"] },
      { slug: "vindkraftinspektion", title: "Vindkraftinspektion", desc: "Automatiserad inspektion av turbinblad med AI-baserad skadedetektering.", longDesc: "Vindkraftverk kräver regelbunden inspektion av blad, nacelle och torn. Drönare med AI-baserad bildanalys automatiserar processen och identifierar sprickor, erosion och delaminering snabbt och kostnadseffektivt.", seoTitle: "Vindkraftinspektion med Drönare — AI-analys | ActionKing", seoDesc: "Inspektera vindkraftverk med drönare. AI-baserad skadedetektering av turbinblad. Minska stilleståndstid med ActionKing.", useCases: ["Bladinspektion av on- och offshore-vindkraftverk", "Periodiskt underhåll och skadeuppföljning", "Garantiärenden och dokumentation", "Storskalig inspektion av vindparker"], keyFeatures: ["AI-baserad skadedetektering", "Automatiserade flygmönster runt turbinblad", "Jämförelse över tid med historisk data", "Detaljerad rapportering med skadeklassificering"] },
      { slug: "solpanelsinspektion", title: "Solpanelsinspektion", desc: "Termisk analys av solcellsanläggningar för att hitta hotspots och defekta celler.", longDesc: "Termisk drönarinspektion av solcellsanläggningar identifierar snabbt defekta celler, hotspots och anslutningsfel som minskar produktionen. Täck stora anläggningar på en bråkdel av tiden jämfört med manuell inspektion.", seoTitle: "Solpanelsinspektion med Drönare — Termisk Analys | ActionKing", seoDesc: "Hitta hotspots och defekta solceller med termisk drönarinspektion. Maximera energiproduktionen. Kontakta ActionKing.", useCases: ["Storskaliga solcellsparker och industrianläggningar", "Villatak med solpaneler", "Kvalitetskontroll vid installation", "Periodisk underhållsinspektion"], keyFeatures: ["Termisk kamera med hög upplösning", "Automatisk hotspot-detektering", "Täck 100+ paneler per timme", "Exporterbara rapporter för underhållsteam"] },
    ],
    recommendedDrones: [
      {
    ...
    faq: [
      ...
      { question: "Behöver jag flygtillstånd för inspektion med drönare?", answer: "I de flesta fall krävs registrering hos Transportstyrelsen och en drönaroperatör med rätt behörighet. ActionKing hjälper dig med alla tillstånd och kan utföra flygningen åt dig." },
  ...
  },
  {
    ...
    faq: [
      ...
      { question: "Är det lagligt att spruta med drönare i Sverige?", answer: "Ja, men det krävs särskilt tillstånd från Kemikalieinspektionen och Jordbruksverket. ActionKing hjälper dig med ansökan och regelefterlevnad." },
  ...
  },
  {
    ...
    solutions: [
      { slug: "3d-modellering", title: "3D-modellering", desc: "Fotogrammetri med centimeterprecision för arkitektur, bygg och kulturarv.", longDesc: "Skapa fotorealistiska 3D-modeller med centimeterprecision genom drönarbaserad fotogrammetri. Perfekt för byggdokumentation, arkitektur, kulturarvsinventering och marknadsföring av fastigheter.", seoTitle: "3D-modellering med Drönare — Fotogrammetri | ActionKing", seoDesc: "Skapa exakta 3D-modeller med drönarbaserad fotogrammetri. Bygg, arkitektur och kulturarv. Kontakta ActionKing.", useCases: ["Byggdokumentation och projektuppföljning", "Kulturarvsinventering och digitalisering", "Fastighetspresentation med 3D-modell", "Arkitekturplanering och visualisering"], keyFeatures: ["Centimeterprecision med RTK", "Fotorealistiska 3D-modeller", "Export till CAD/BIM-format", "Automatisk punktmolnsgenerering"] },
      { slug: "volymberakning", title: "Volymberäkning", desc: "Mät stockhögar, gravar och materialvolymer med drönare istället för manuell mätning.", longDesc: "Drönarbaserad volymberäkning ersätter tidskrävande manuell mätning med exakta resultat på minuter. Beräkna volymer av stockhögar, grushögar, grävda schakt och materialupplag med hög noggrannhet.", seoTitle: "Volymberäkning med Drönare — Exakt & Snabbt | ActionKing", seoDesc: "Mät volymer med drönare istället för manuell mätning. Stockhögar, grushögar och schakt. Kontakta ActionKing.", useCases: ["Lagervolymberäkning i gruvor och täkter", "Stockmätning i skogsindustrin", "Massabalansberäkning vid schaktarbeten", "Inventering av materialupplag"], keyFeatures: ["Noggrannhet inom 1-2% av verklig volym", "RTK-precision", "Automatisk rapport med volymdata", "Jämförelse över tid med historisk data"] },
      { slug: "terrangmodeller", title: "Terrängmodeller", desc: "Digitala terrängmodeller (DTM/DSM) för markplanering och infrastrukturprojekt.", longDesc: "Skapa digitala terrängmodeller (DTM) och ytmodeller (DSM) med drönardata för markplanering, väg- och ledningsprojekt och hydrologisk analys. Snabbare och billigare än traditionella metoder.", seoTitle: "Terrängmodeller med Drönare — DTM/DSM | ActionKing", seoDesc: "Skapa digitala terrängmodeller med drönare. DTM/DSM för bygg, infrastruktur och planering. Kontakta ActionKing.", useCases: ["Vägplanering och projektering", "Hydrologisk analys och dagvattenhantering", "Markförberedelse och massbalans", "Detaljplaner och exploateringsprojekt"], keyFeatures: ["Hög punktdensitet med LiDAR eller fotogrammetri", "DTM/DSM i standard GIS-format", "Höjdkurvor och sektionsritningar", "Integration med CAD och GIS-system"] },
      { slug: "bim-integration", title: "BIM-integration", desc: "Exportera drönardata direkt till BIM-system för byggprojektsuppföljning.", longDesc: "Integrera drönardata direkt i BIM-system för att jämföra planerat bygge mot verklighet. Följ upp byggprojekt med regelbundna drönarflygningar och identifiera avvikelser tidigt.", seoTitle: "BIM-integration med Drönardata — Bygguppföljning | ActionKing", seoDesc: "Integrera drönardata i BIM-system. Jämför planerat mot byggt och följ upp byggprojekt. Kontakta ActionKing.", useCases: ["Regelbunden byggplatsuppföljning", "Avvikelseanalys mot BIM-modell", "As-built dokumentation", "Kvalitetssäkring vid betonggjutningar"], keyFeatures: ["Automatisk jämförelse med BIM", "Punktmoln i IFC/RCP-format", "Regelbunden flygschemaläggning", "Avvikelserapporter med visualisering"] },
    ],
    recommendedDrones: [
      {
        name: "DJI Matrice 350 RTK",
  ...
  },
  {
    ...
    solutions: [
      { slug: "ledningsinspektion", title: "Ledningsinspektion", desc: "Automatiserad inspektion av kraftledningar med zoom och termisk kamera.", longDesc: "Drönare inspekterar kraftledningar snabbt och säkert utan att personal behöver klättra i master eller använda helikopter. Termisk kamera identifierar hotspots och zoom avslöjar mekaniska skador.", seoTitle: "Ledningsinspektion med Drönare — Kraftledningar | ActionKing", seoDesc: "Inspektera kraftledningar med drönare. Termisk och visuell inspektion utan helikopter. Kontakta ActionKing.", useCases: ["Regionsinspektion av transmissionsnät", "Vegetationsanalys längs ledningsgator", "Stormskadeinspektion", "Periodisk underhållsinspektion"], keyFeatures: ["Automatiserade flygmönster längs ledningar", "Termisk hotspot-detektion", "200× zoom för detaljgranskning", "AI-assisterad skadeklassificering"] },
      { slug: "transformatorinspektion", title: "Transformatorinspektion", desc: "Detektera hotspots och anomalier i transformatorer och ställverk.", longDesc: "Termisk drönarinspektion av transformatorer och ställverk identifierar överbelastade komponenter, dåliga anslutningar och begynnande fel innan de leder till haveri och strömavbrott.", seoTitle: "Transformatorinspektion med Drönare — Termisk Analys | ActionKing", seoDesc: "Inspektera transformatorer med termisk drönare. Hitta hotspots innan de orsakar haveri. Kontakta ActionKing.", useCases: ["Ställverksinspektion utan avbrott", "Termisk övervakning av transformatorer", "Dokumentation för underhållsplanering", "Kabelbropps- och isolatorinspektion"], keyFeatures: ["Termisk kamera med hög upplösning", "Zoom för isolator- och anslutningsdetaljer", "Inspektion utan driftstopp", "Automatiserade rapporter med termogrammer"] },
      { slug: "solparksinspektion", title: "Solparksinspektion", desc: "Storskalig termisk analys av solcellsparker för att maximera produktion.", longDesc: "Drönare med termisk kamera kan snabbt täcka stora solcellsparker och identifiera defekta moduler, hotspots och anslutningsfel som minskar energiproduktionen.", seoTitle: "Solparksinspektion med Drönare — Maximera Produktion | ActionKing", seoDesc: "Termisk inspektion av solcellsparker med drönare. Hitta defekta moduler och maximera produktion. Kontakta ActionKing.", useCases: ["Storskaliga solcellsparker (MW-klassen)", "Garantiärenden och modulreklamationer", "Periodisk underhållsinspektion", "Kvalitetskontroll vid nyinstallation"], keyFeatures: ["Termisk avbildning av hela parken", "Automatisk defektklassificering", "MW-skala på timmar istället för veckor", "IEC-kompatibla inspektionsrapporter"] },
      { slug: "vindkraftsinspektion-energi", title: "Vindkraftsinspektion", desc: "Bladinspektion med AI-analys och automatiserad rapportering.", longDesc: "Vindkraftsinspektioner med drönare minskar stilleståndstid och inspektionskostnader drastiskt. AI-baserad bildanalys klassificerar skador och genererar underhållsrekommendationer automatiskt.", seoTitle: "Vindkraftsinspektion med Drönare — AI-analys | ActionKing", seoDesc: "Inspektera vindkraftverk med drönare och AI. Minska stillestånd och inspektionskostnader. Kontakta ActionKing.", useCases: ["On- och offshore-vindparker", "Periodisk bladinspektion", "Stormskadeinspektion", "Garantiuppföljning och dokumentation"], keyFeatures: ["AI-baserad skadeklassificering", "Automatiserade inspektionsmönster", "Jämförelse med tidigare inspektioner", "Integration med CMMS-system"] },
    ],
    recommendedDrones: [
      {
        name: "DJI Matrice 350 RTK",
  ...
  },
  {
    ...
    faq: [
      { question: "Behöver jag flygcertifikat för drönarfilmning?", answer: "Ja, kommersiell drönarflygning kräver registrering hos Transportstyrelsen och relevant behörighet. ActionKing erbjuder utbildning och kan även tillhandahålla certifierade piloter." },
